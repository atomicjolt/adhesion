...
describe('Range Picker', () => {
  ...
  it('should open calender 1 when icon is clicked', () => {
    const cal1Icon = TestUtils.scryRenderedDOMComponentsWithClass(result, 'c-btn--date')[0];
  ...
  it('should open calender 2 when icon is clicked', () => {
    const cal2Icon = TestUtils.scryRenderedDOMComponentsWithClass(result, 'c-btn--date')[1];
