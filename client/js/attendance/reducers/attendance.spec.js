...
describe('attendance reducer', () => {
  let state, action, date, attendance;
  ...
  beforeEach(() => {
    ...
    attendance = [
      ...
      {lms_student_id: "3", status: 'ABSENT', date: date},
      {lms_student_id: "4", status: 'ABSENT', date: date},
      {lms_student_id: "5", status: 'ABSENT', date: date},
      {lms_student_id: "6", status: 'ABSENT', date: date},
      {lms_student_id: "7", status: 'ABSENT', date: date},
      {lms_student_id: "8", status: 'ABSENT', date: date}
    ];
  });
