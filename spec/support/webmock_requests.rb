...
RSpec.configure do |config|
  config.before(:each) do
    ...
    stub_request(:post, %r|http[s]*://[a-zA-Z0-9]+\.[a-zA-Z0-9]+.*com/api/v1/courses/.+/assignments|).
      to_return(
        status: 200,
    ...
    stub_request(:get, %r|http[s]*://[a-zA-Z0-9]+\.[a-zA-Z0-9]+.*com/api/v1/users/.+/enrollments|).
      to_return(
        status: 200,
        body: canvas_student_enrollments,
        headers: canvas_headers,
      )

    stub_request(:get, %r|http[s]*://[a-zA-Z0-9]+\.[a-zA-Z0-9]+.*com/api/v1/sections/.+/assignments/.+/submissions|).
      to_return(
        status: 200,
        body: canvas_assignment_submissions_sections,
        headers: canvas_headers,
      )
